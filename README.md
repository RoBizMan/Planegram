...
| [OpenSky Network](https://opensky-network.org/datasets/metadata/) | entire site | Extract the world's current aircraft database and upload to my aircraft database |
...
| --- | --- | --- | --- |
| [Pexels](https://www.pexels.com) | entire site | images | favicon on all pages |
| [Pexels](https://www.pexels.com) | entire site | images | images of planes in grams & detailed gram pages |
...
- I would like to thank my friend, Andrzej Rosołowski, for visiting my website and feeding me with their feedback so that I can continue improving/enhancing UX design on my website.